...
(() => {
  ...
  function createOverlay() {
    ...
    // Localized labels land via textContent/setAttribute — the template
    // above stays ONE static literal, so no dynamic string ever reaches
    // innerHTML (AMO unsafe-assignment rule).
